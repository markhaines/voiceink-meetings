...
final class CoreAudioRecorder: @unchecked Sendable {
    ...
    private let logger = Logger(subsystem: "com.hainesy.voiceinkmeetings", category: "CoreAudioRecorder")
    ...
    private let audioProcessingQueue = DispatchQueue(
        label: "com.hainesy.voiceinkmeetings.audioProcessing", qos: .userInitiated)
