...
class Recorder: NSObject, ObservableObject {
    ...
    let logger = Logger(subsystem: "com.hainesy.voiceinkmeetings", category: "Recorder")
    ...
    let audioSetupQueue = DispatchQueue(label: "com.hainesy.voiceinkmeetings.audioSetup", qos: .userInitiated)
